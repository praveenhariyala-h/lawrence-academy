...
const pathways = [
  {
    title: "Learn",
    detail: "Academics",
    image: "/images/pathway/learn.png",
    position: "center 30%",
    icon: (
  ...
  },
  {
    title: "Innovate",
    detail: "Robotics",
    image: "/images/pathway/innovate.png",
    position: "72% 40%",
    icon: (
      <svg viewBox="0 0 48 48" aria-hidden="true">
  ...
  },
  {
    title: "Explore",
    detail: "Competition",
    image: "/images/pathway/explore.png",
    position: "center 35%",
    icon: (
      <svg viewBox="0 0 48 48" aria-hidden="true">
  ...
  },
  {
    title: "Create",
    detail: "Art",
    image: "/images/pathway/create.png",
    position: "58% 38%",
    icon: (
      <svg viewBox="0 0 48 48" aria-hidden="true">
  ...
  },
  {
    title: "Perform",
    detail: "Sports",
    image: "/images/pathway/perform.png",
    position: "center 30%",
    icon: (
      <svg viewBox="0 0 48 48" aria-hidden="true">
        ...
        <div className="pathway-strip" ref={stripRef}>
          {pathways.map((item, index) => (
            ...
            >
              ...
              <span className="pathway-icon">{item.icon}</span>
